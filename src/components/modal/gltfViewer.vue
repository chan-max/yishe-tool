...
<script setup>
import { defineProps,ref,onMounted, render,watch,nextTick} from "vue";
import { OrbitControls } from "three/examples/jsm/controls/OrbitControls";
import { AmbientLight, Box3, BoxGeometry, DirectionalLight, Mesh, MeshBasicMaterial, PerspectiveCamera, Scene, Vector3, WebGLRenderer } from "three";
...
function initImportedModel(gltf) {
  ...
  async function mountModel(){
    ...
    let resizeOb = new ResizeObserver(debounce(() => {  
