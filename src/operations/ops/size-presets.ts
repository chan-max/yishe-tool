...
export const sizePresets: SizePreset[] = [
  ...
  },
  {
    id: "sticker-5x5",
    name: "5×5 英寸大贴纸",
    nameEn: '5×5" Large Sticker',
    category: "贴纸",
    width: 1500,
    height: 1500,
    unit: "px",
    description: "5英寸方形大贴纸",
    tags: ["sticker", "贴纸", "5inch", "large"],
    dpi: 300,
    printArea: { width: 12.7, height: 12.7, unit: "cm" },
  },
  {
    id: "sticker-6x6",
    name: "6×6 英寸大贴纸",
    nameEn: '6×6" Large Sticker',
    category: "贴纸",
    width: 1800,
    height: 1800,
    unit: "px",
    description: "6英寸方形大贴纸",
    tags: ["sticker", "贴纸", "6inch", "large"],
    dpi: 300,
    printArea: { width: 15.24, height: 15.24, unit: "cm" },
  },
  {
    id: "sticker-8x8",
    name: "8×8 英寸超清贴纸",
    nameEn: '8×8" HD Sticker',
    category: "贴纸",
    width: 2400,
    height: 2400,
    unit: "px",
    description: "8英寸超清方形贴纸",
    tags: ["sticker", "贴纸", "8inch", "hd", "超清"],
    dpi: 300,
    printArea: { width: 20.32, height: 20.32, unit: "cm" },
  },
  {
    id: "sticker-10x10",
    name: "10×10 英寸超清大面积贴纸",
    nameEn: '10×10" Ultra HD Sticker',
    category: "贴纸",
    width: 3000,
    height: 3000,
    unit: "px",
    description: "10英寸超清大面积贴纸",
    tags: ["sticker", "贴纸", "10inch", "ultrahd", "大面积"],
    dpi: 300,
    printArea: { width: 25.4, height: 25.4, unit: "cm" },
  },
  {
    id: "sticker-4x6",
    name: "4×6 英寸贴纸页",
    nameEn: '4×6" Sticker Sheet',
    category: "贴纸",
    width: 1200,
    height: 1800,
    unit: "px",
    description: "4×6英寸不干胶贴纸页",
    tags: ["sticker", "贴纸", "4x6", "贴纸页"],
    dpi: 300,
    printArea: { width: 10.16, height: 15.24, unit: "cm" },
  },
  {
    id: "sticker-a4-sheet",
    name: "A4 贴纸页",
    nameEn: "A4 Sticker Sheet",
    category: "贴纸",
    width: 2480,
    height: 3508,
    unit: "px",
    description: "A4整版贴纸页 (21x29.7cm)",
    tags: ["sticker", "贴纸", "贴纸页", "a4", "整版"],
    dpi: 300,
    printArea: { width: 21, height: 29.7, unit: "cm" },
  },
  {
...
export const SIZE_PRESET_LIST_FOR_PROMPT = sizePresets
  .map(
    (p) =>
      `[${p.id}] ${p.name} (${p.nameEn}) — ${p.width}x${p.height}${p.unit}` +
      (p.printArea
        ? ` | 印刷区 ${p.printArea.width}x${p.printArea.height}${p.printArea.unit}`
        : "") +
