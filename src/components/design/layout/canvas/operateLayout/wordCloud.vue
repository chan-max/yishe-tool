<template>
  <el-collapse v-model="activeNames">
    <el-collapse-item name="basic" title="基础">
      <operate-form-item>
        <template #name>词云引擎</template>
        <template #content>
          <el-select v-model="currentOperatingCanvasChild.wordCloud.engine" size="small">
            <el-option
    ...
    <el-collapse-item name="presentation" title="表现">
      <operateItemFontFamily v-model="wordcloud2.fontFamilyInfo"></operateItemFontFamily>

      <operate-form-item>
        <template #name>备用字体</template>
        <template #content>
          <el-input v-model="wordcloud2.fontFamily" size="small" placeholder="sans-serif"></el-input>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input v-model="wordcloud2.fontWeight" size="small" placeholder="normal / bold / 600"></el-input>
        </template>
      </operate-form-item>
      ...
      <operate-form-item v-if="wordcloud2.colorMode === 'palette'" style="align-items: start;">
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input v-model="wordcloud2.backgroundColor" size="small" placeholder="rgba(0,0,0,0)"></el-input>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.minSize" size="small" :min="0"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.weightFactor" size="small" :min="0" :step="0.1"></el-input-number>
        </template>
      </operate-form-item>
    ...
    <el-collapse-item name="dimension" title="布局">
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.gridSize" size="small" :min="1"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="originX" size="small" :min="0" placeholder="自动"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="originY" size="small" :min="0" placeholder="自动"></el-input-number>
        </template>
      </operate-form-item>
    ...
    <el-collapse-item name="mask" title="遮罩调试">
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.maskGapWidth" size="small" :min="0" :step="0.1"></el-input-number>
        </template>
      </operate-form-item>
    </el-collapse-item>
    ...
    <el-collapse-item name="timing" title="性能">
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.wait" size="small" :min="0"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.abortThreshold" size="small" :min="0"></el-input-number>
        </template>
      </operate-form-item>
    </el-collapse-item>
    ...
    <el-collapse-item name="rotation" title="旋转">
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.rotateRatio" size="small" :min="0" :max="1" :step="0.05"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="minRotationDeg" size="small" :step="15"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="maxRotationDeg" size="small" :step="15"></el-input-number>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.rotationSteps" size="small" :min="0" :step="1"></el-input-number>
        </template>
      </operate-form-item>
    </el-collapse-item>
    ...
    <el-collapse-item name="shape" title="形状">
      <operate-form-item>
        ...
        <template #content>
          <el-select v-model="wordcloud2.shape" size="small">
            <el-option v-for="shape in shapeOptions" :key="shape" :label="shape" :value="shape"></el-option>
          </el-select>
        </template>
      </operate-form-item>
      ...
      <operate-form-item>
        ...
        <template #content>
          <el-input-number v-model="wordcloud2.ellipticity" size="small" :min="0.1" :step="0.1"></el-input-number>
        </template>
      </operate-form-item>
...
const activeNames = ref(['basic', 'presentation', 'dimension', 'rotation', 'shape', 'common'])
const engineOptions = [
  {
    label: 'WordCloud2',
    value: 'wordcloud2',
...
const shapeOptions = ['circle', 'cardioid', 'diamond', 'square', 'triangle-forward', 'triangle', 'pentagon', 'star']
...
const originX = computed({
  get() {
    return Array.isArray(wordcloud2.value.origin) ? wordcloud2.value.origin[0] : undefined
  },
...
const originY = computed({
  get() {
    return Array.isArray(wordcloud2.value.origin) ? wordcloud2.value.origin[1] : undefined
  },
  set(value: number | undefined) {
    setOrigin(1, value)
  },
...
function applyWordListText() {
  const list = wordListText.value
    ...
    .filter(Boolean)
    .map((line) => {
      const [text, weight = '20', ...extra] = line.split(',').map((item) => item.trim())
      return [text, Number(weight) || 0, ...extra].filter((item) => item !== '')
    })
