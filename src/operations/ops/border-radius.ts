...
registerOperation({
  ...
  name: "设置圆角",
  description:
    "设置元素圆角。常见值：4-8px 微圆角，12-20px 卡片圆角，50%或极大值做圆形/胶囊。适用于 rect、image、html 等元素。",
  group: "样式",
  params: [
    {
      name: "id",
  ...
  execute(params, ctx) {
    ...
    return {
      success: true,
      message: `已设置 ${childType} 元素 (${id}) 圆角: ${borderRadius}px`,
      data: { id, type: childType, borderRadius },
    };
  },
});
