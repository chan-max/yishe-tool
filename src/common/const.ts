 ...
 * @LastEditTime: 2025-06-02 19:43:23
 * @FilePath: /1s/src/common/const.ts
...
export default {
    ...
    RecourceFileAcceptString:'image/png,image/webp, image/jpeg, image/svg+xml, font/ttf, font/woff, font/otf, application/vnd.adobe.photoshop,.psd, .glb',
