                    ...
                    <el-row style="row-gap: 1rem">
                        <el-col :span="24">
                            ...
                            <el-tabs v-model="activeCategory">
                                <el-tab-pane v-for="category in CustomBackgroundCategoryOptions" :name="category.value"
                                    :label="category.label">
                                    <el-scrollbar height="360px">
                                        <el-row v-if="withSearchFilter(category.children).length"
                                            style="row-gap:.6rem;margin:1rem;">
                                            <el-col v-for="item, index in withSearchFilter(category.children)" :key="index"
                                                :span="4">
                                                <div class="flex flex-col justify-center items-center preview-item"
                                                    ...
                                                    <div style="text-align: center;height:16px;line-height:16px;"
                                                        class="text-ellipsis"> {{
                                                            item.label
                                                        }}</div>
                                                </div>
                                        ...
                                        <el-empty v-else @click="searchInput = ''" class="cursor-pointer" description="无结果"
                                            :image="emptyImage" :image-size="64">
                                        </el-empty>
                                    </el-scrollbar>
                                </el-tab-pane>
                            </el-tabs>
...
const activeCategory = useLocalStorage('_1s_BuiltInBackgroundActiveCategory', SvgFilterCategory.Normal);
