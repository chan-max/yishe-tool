...
2. **添加完整 HTML 作品** — 背景、装饰、主要文字、副文字都放在同一个 HTML 元素中
3. **完成即停** — 完整作品添加成功后不要继续重写，除非用户明确要求继续优化
4. **用户要求保存时** — 使用 canvas.updateAndSaveSticker 或 canvas.exportPng
